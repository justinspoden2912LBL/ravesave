    ...
    <Dialog open={open} onOpenChange={(v) => { setOpen(v); if (!v) reset(); }}>
      <DialogTrigger asChild>
        <button
          ...
          className="fixed z-50 print:hidden hidden md:inline-flex items-center gap-2 rounded-full bg-destructive px-4 py-3 text-sm font-semibold text-destructive-foreground shadow-lg ring-2 ring-destructive/40 hover:brightness-110 hover:scale-[1.03] active:scale-95 transition motion-safe:animate-pulse motion-reduce:animate-none"
        >
